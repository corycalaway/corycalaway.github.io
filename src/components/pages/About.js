...
const About = () => (
  <section id="about-me" className="flex-section">
        <div className="right-border">
            <h3 className="section-title">About<br />Me</h3>
        </div>
        <p className="primary-text">My name is Cory! I am an father/developer/nerd/etc and so on. I have had a plethora of experiences
