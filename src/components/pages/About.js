...
const About = () => (
  <section id="about-me" class="flex-section">
        <div class="right-border">
            <h3 class="section-title">About<br />Me</h3>
        </div>
        <p class="primary-text">My name is Cory! I am an father/developer/nerd/etc and so on. I have had a plethora of experiences
